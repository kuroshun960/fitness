...
<div class="meallistpage__hidden">    
    ...
    <div class="mealtype__linkBtn">
        ...
        <?php echo link_to_route('snacks.show','おやつリスト',[],['class'=>'userRegistBtn']); ?>
            ...
            <?php $__currentLoopData = $meals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $meal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if( $meal['mealType'] === '食事'): ?>
                    ...
                    <div class="itemsHead itemsHead__link">
                        ...
                        <p><?php echo e($meal['mealFat']); ?>f</p>
                        <p><?php echo e($meal['mealCarbo']); ?>c</p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /work/resources/views/mealssetting.blade.php ENDPATH**/ ?>